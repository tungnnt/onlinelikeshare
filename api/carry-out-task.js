...
module.exports = async (cookie, token, imagePath, takeId, groupAdmin = '4234169246827020288') => {
    const headers = {
    ...
    const options = {
        url: 'https://onlinelikeshare.xyz/api/Task/CarryOutTask',
        method: 'POST'
    }
